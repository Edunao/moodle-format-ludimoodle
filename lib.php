...
/**
 * This file contains main class for the course format Ludimoodle
 *
 * @package    course
...
/**
 * Main class for the ludimoodle course format
 *
 * @package    course
 * @subpackage format_ludimoodle
 * @copyright  2020 Edunao SAS (contact@edunao.com)
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class format_ludimoodle extends format_base {
     ...
     *
     * ludimoodle format uses the following options:
     * - coursedisplay
     * - hiddensections
     *
    ...
    /**
     * Set section options to be display in the moodle form
     *
     * @param boolean $foreditform unused default false
     * @return array section form elements
    ...
    public function section_format_options($foreditform = false) {
        ...
        if ($sectionformatoptions === false) {
            ...
            $sectionformatoptions = array(
                    'sectioncanhavemotivator' => array(
                            'type'           => PARAM_INT,
                            'label'          => get_string('sectioncanhavemotivatorlabel', 'format_ludimoodle'),
                            'element_type'   => 'advcheckbox',
                            'default'        => 1,
                            'help'           => 'sectioncanhavemotivator',
    ...
    /**
     * Display motivators on each course page
     *
     * @return format_ludimoodle_motivators|renderable|null
     */
    function course_header() {
        global $PAGE;
        return new format_ludimoodle_motivators($PAGE->course->id);
    }
    ...
    if ($itemtype === 'sectionname' || $itemtype === 'sectionnamenl') {
        $section = $DB->get_record_sql(
           'SELECT s.* 
            ...
            WHERE s.id = ? 
              AND c.format = ?', array($itemid, 'ludimoodle'), MUST_EXIST);

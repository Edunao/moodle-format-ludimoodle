...
/**
 * This motivator is the default motivator when a section doesn't has a motivator (section parameter)
 *
 * @package    course
...
class motivator_nomotivator extends motivator_base implements i_motivator {
    ...
    public function render_mod_view($env, $cm){
        ...
        $output .= '<div class="ludi-nomotivator ludi-mod-view">';
        $output .= '<img class="ludi-nomotivator-image " src="' . $baseimage . '" >';
        $output .= '</div>';
    ...
    public function render_summary_mod_view($env, $cm){
        ...
        // Render
        $output = $this->include_css($env);
        $output .= '<div class="ludi-nomotivator ludi-summary-mod-view">';
        $output .= '<img class="ludi-nomotivator-image " src="' . $baseimage . '" >';
        $output .= '</div>';
    ...
    public function render_section_view($env, $section){
        ...
        // Render
        $output = $this->include_css($env);
        $output .= '<div class="ludi-nomotivator ludi-section-view">';
        $output .= '<img class="ludi-nomotivator-image " src="' . $baseimage . '" >';
        $output .= '</div>';
    ...
    public function render_summary_section_view($env, $section){
        ...
        // Render
        $output = $this->include_css($env);
        $output .= '<div class="ludi-nomotivator ludi-summary-section-view">';
        $output .= '<img class="ludi-nomotivator-image " src="' . $baseimage . '" >';
        $output .= '</div>';
